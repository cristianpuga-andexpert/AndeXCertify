    ...
    <div className="max-w-4xl mx-auto py-16 px-6">
      <div className="mb-12">
        ...
        <h1 className="text-4xl font-black text-slate-900 tracking-tight leading-none">
          Crear <span className="text-brand">Nuevo Curso</span>
        </h1>
      </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4">
              ...
              <div className="col-span-full mt-8">
                ...
                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-6">Imagen de Fondo Personalizada</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-slate-900 rounded-2xl p-8 flex flex-col justify-center border-l-8 border-brand">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <h4 className="text-[10px] font-black text-white uppercase tracking-widest leading-none">¿Cómo funciona el fondo?</h4>
                    </div>
                    <p className="text-[9px] text-white/60 font-bold uppercase leading-relaxed mb-4">
                      La imagen se mostrará detrás del contenido del certificado (nombre, firmas, QR). Úsela si tiene un diseño pre-impreso o una plantilla gráfica propia.
                    </p>
        ...
        {step === 4 && (
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
            <div className="border-l-4 border-brand pl-6">
              ...
              <p className="text-slate-500 text-xs mt-1 font-medium">Revise los datos antes de crear el curso.</p>
            </div>

            <div className="bg-slate-900 p-10 rounded-2xl space-y-6">
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Nombre Interno</span>
              ...
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Tipo de Curso</span>
              ...
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">QR del Certificado</span>
